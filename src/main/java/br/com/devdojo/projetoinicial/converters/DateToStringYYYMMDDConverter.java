 ...
 */
@FacesConverter(value = "dateToStringYYYMMDDConverter")
public class DateToStringYYYMMDDConverter implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
        ...
        return Functions.formateDateStringYYYYMMDDToDate(submittedValue);
